...
- (id)initWithSectionTitles:(NSArray *)sectiontitles {
    ...
    label.text=@"";
    label.frame = CGRectMake(0, self.height-4, self.frame.size.width, 4);
...
- (CGRect)frameForSelectionIndicator {
    ...
    if (self.selectionIndicatorMode == HMSelectionIndicatorResizesToStringWidth) {
        ...
        return CGRectMake(x, self.frame.size.height-5, stringWidth, self.selectionIndicatorHeight);
    } else {
        return CGRectMake(self.segmentWidth * self.selectedIndex, self.frame.size.height-4, self.segmentWidth, self.selectionIndicatorHeight);
    }
}
